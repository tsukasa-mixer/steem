...
namespace steemit { namespace example_api_plugin {
...
} } // steemit::example_api_plugin

// Args and return types need to be reflected. hello_world_args does not because it is a typedef of a reflected type
FC_REFLECT( steemit::example_api_plugin::hello_world_return, (message) )
FC_REFLECT( steemit::example_api_plugin::echo_args, (call) )
FC_REFLECT( steemit::example_api_plugin::echo_return, (response) )
